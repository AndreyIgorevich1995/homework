...
public class Student {
    ...
    //    private List<Integer> resultsTestEnglish1 = new ArrayList<>(TestsEnglish.getQuestions1().length);
//    private List<Integer> resultsTestEnglish2 = new ArrayList<>(TestsEnglish.getQuestions2().length);
//    private List<Integer> resultsTestEnglish3 = new ArrayList<>(TestsEnglish.getQuestions3().length);
//    private List<Integer> resultsTestMath1 = new ArrayList<>(TestsMath.getQuestions1().length);
//    private List<Integer> resultsTestMath2 = new ArrayList<>(TestsMath.getQuestions2().length);
//    private List<Integer> resultsTestMath3 = new ArrayList<>(TestsMath.getQuestions3().length);
